<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContentNew.ascx.cs" ClassName="DefaultVerticalTemplateContentNew" Inherits="CustomizeTemplate.Web.DefaultVerticalTemplateContentNew" %>
