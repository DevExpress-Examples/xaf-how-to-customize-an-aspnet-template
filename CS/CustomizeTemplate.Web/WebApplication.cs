...
using CustomizeTemplate.Module.BusinessObjects;
...
namespace CustomizeTemplate.Web {
    ...
    public partial class CustomizeTemplateAspNetApplication : WebApplication {
        ...
        private CustomizeTemplate.Module.Web.CustomizeTemplateAspNetModule module4;
        ...
        protected override void CreateDefaultObjectSpaceProvider(CreateCustomObjectSpaceProviderEventArgs args) {
            if(args.Connection != null) {
                args.ObjectSpaceProvider = new EFObjectSpaceProvider(typeof(CustomizeTemplateDbContext), TypesInfo, null, (DbConnection)args.Connection);
            }
            else {
                args.ObjectSpaceProvider = new EFObjectSpaceProvider(typeof(CustomizeTemplateDbContext), TypesInfo, null, args.ConnectionString);
            }
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new CustomizeTemplate.Module.Web.CustomizeTemplateAspNetModule();
