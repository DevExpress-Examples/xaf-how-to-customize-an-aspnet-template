<%@ Control Language="vb" CodeBehind="DefaultVerticalTemplateContentNew.ascx.vb" ClassName="DefaultVerticalTemplateContentNew" Inherits="CustomizeTemplate.Web.DefaultVerticalTemplateContentNew" %>
